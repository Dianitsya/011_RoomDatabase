package com.example.roomsiswaa.ui.halaman
...
import com.example.roomsiswaa.model.DetailViewModel
import com.example.roomsiswaa.model.ItemDetailsUiState
import com.example.roomsiswaa.model.PenyediaViewModel
import com.example.roomsiswaa.model.toSiswa
...
private fun ItemDetailsBody(
 ...
 Column (
     ...
     ItemDetails(siswa = itemDetailuiState.detailSiswa.toSiswa(),
     ...
     if(deleteConfirmationRequired){
         DeleteConfirmationDialog( {deleteConfirmationRequired = false
                 onDelete()},
